        ...
        <div>
            <div className=" w-full text-white flex  items-center mt-12">
                ...
                <div className="ml-auto mr-14">
                    <button className="bg-gray-100 text-black hover:bg-[#979996] text-sm font-bold py-3 px-6 rounded mr-4">Sign Up</button>
            ...
            <div className="max-w-7xl mx-auto mt-24 bg-gray-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="flex justify-center">
                    ...
                    <div className="w-1/2 ml-2">
                        <p className="text-gray-700 text-center text-2xl font-bold ml-8 mb-4 mt-28">Want to join our Family </p>
                        <form >
                            ...
                            <div className="flex items-center justify-between">
                                <button className="bg-[#608D4B] hover:bg-[#43712E] text-white font-semibold mt-4 py-2 px-8 rounded focus:outline-none focus:shadow-outline" type="button">
                                    Sign Up
                                </button>
                            </div>
                        ...
                        <div className="flex items-center ">
                            <p className=" text-gray-500 text-sm mt-8 ">Or you can join with </p>
                        ...
                        <div className="flex mt-5">
                            <p className="text-gray-500 text-sm">Already have an account? <a href="#" className="font-semibold hover:underline" style={{ color: "#608D4B" }} >Log in </a></p>
